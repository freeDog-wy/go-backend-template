...
// Repository 实现 domain/user.Repository，基于 GORM 泛型 API。
type Repository struct {
	db *gorm.DB
}

var _ domainUser.Repository = (*Repository)(nil)
...
func (r *Repository) g(ctx context.Context) gorm.Interface[modelUser.User] {
	return gorm.G[modelUser.User](database.DB(ctx, r.db))
}

func (r *Repository) FindByID(ctx context.Context, id uint) (*domainUser.User, error) {
