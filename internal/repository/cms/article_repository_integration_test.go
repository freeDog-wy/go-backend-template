...
func TestArticleRepositoryIntegrationConstraintsAndLifecycle(t *testing.T) {
	...
	publishedItems, publishedTotal, err := fixture.repo.ListArticleTranslations(fixture.ctx, "zh-CN", domainCMS.TranslationPublished, false, false, shared.NewPageQuery(1, 20))
