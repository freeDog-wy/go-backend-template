...
var _ domainMedia.Storage = (*R2)(nil)
...
func (r *R2) HeadObject(ctx context.Context, key string) (*domainMedia.ObjectInfo, error) {
...
func (r *R2) PresignUpload(ctx context.Context, key, contentType string) (*domainMedia.PresignedUpload, error) {
	...
	return &domainMedia.PresignedUpload{URL: request.URL, Headers: map[string]string{"Content-Type": contentType}, ExpiresAt: time.Now().Add(r.ttl)}, nil
}
